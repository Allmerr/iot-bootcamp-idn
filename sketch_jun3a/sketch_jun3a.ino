...
#define WLAN_SSID "Robotic" //Nama Wi-Fi
#define WLAN_PASS "idnmantab" //Password
#define AIO_SERVER "io.adafruit.com" //Broker atau Server
#define AIO_SERVERPORT 1883 //Port MQTT

#define AIO_USERNAME "kevinalmer" //Username Adafruit IO
#define AIO_KEY "aio_GxJo74m8EFI66WxtuAb3s7Bi1eRS" //Key Adafruit IO
...
Adafruit_MQTT_Subscribe lampu2 = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/relay"); //Fungsi untuk Subscribe ke Topik Relay1
...
void loop() {
  ...
  //Konversi Variabel Float / Double ke String dengan 4 nilai didepan koma dan 2 nilai di belakang koma
