...
#define USERNAME "kevinalmer" //Username Thinger IO
#define DEVICE_ID "MCUNR" //Device ID Thinger IO
#define DEVICE_CREDENTIAL "hvrres+nGQndyAyS" //Device Credential Thinger IO
#define SSID "ya misikin" //SSID Wi-Fi
#define SSID_PASSWORD "dark angel" //Password Wi-Fi
